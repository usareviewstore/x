            ...
            <div id="pricing-card" className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200/90 shadow-xl shadow-slate-200/50 space-y-6 sticky top-24">
              ...
              {service.price !== null ? (
                <button
                  ...
                  className="w-full py-3.5 px-6 bg-blue-600 hover:bg-blue-700 text-white font-extrabold text-sm sm:text-base rounded-xl transition-colors shadow-sm flex items-center justify-center gap-2.5 cursor-pointer group"
                >
