  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
      ...
      <div className="bg-white p-8 rounded-xl border border-slate-200 shadow-xs space-y-4">
        <h2 className="text-2xl font-bold text-slate-900">Empowering Authentic Customer Trust</h2>
      ...
      {/* Contact Prompt */}
      <div className="bg-slate-900 border border-slate-800 p-8 rounded-xl text-center space-y-4 text-white">
        <h3 className="text-xl font-bold text-white">Have Questions About Our Reputation Services?</h3>
        ...
        <button
          ...
          className="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs rounded-lg shadow-xs inline-flex items-center gap-2 transition-colors cursor-pointer"
        >
