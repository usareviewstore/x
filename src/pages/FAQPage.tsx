          ...
          return (
            ...
            >
              <button
                ...
                className="w-full p-4 sm:p-5 text-left flex justify-between items-center gap-4 cursor-pointer focus:outline-hidden"
              >
                <div className="flex items-center gap-3">
                  <span className="text-[11px] font-bold px-2.5 py-0.5 rounded-md bg-slate-100 text-slate-700 shrink-0">
                    {faq.category}
                  </span>
      ...
      <div className="bg-slate-900 text-white p-8 rounded-xl text-center space-y-4">
        ...
        <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
          <a
            ...
            className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs rounded-lg transition-colors flex items-center gap-2 cursor-pointer"
          >
          ...
          <button
            ...
            className="px-5 py-2.5 bg-slate-800 hover:bg-slate-700 text-slate-200 font-bold text-xs rounded-lg border border-slate-700 transition-colors cursor-pointer"
          >
            Contact Form
          </button>
        </div>
