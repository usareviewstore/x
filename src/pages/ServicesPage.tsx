        ...
        <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
          ...
          <div className="relative w-full md:w-96">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:outline-hidden focus:border-blue-500 focus:bg-white text-slate-900 placeholder-slate-400"
            />
            {searchQuery && (
              <button
                type="button"
